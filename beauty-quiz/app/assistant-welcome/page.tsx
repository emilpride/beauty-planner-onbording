  ...
  return (
    <div className="relative min-h-[100dvh] overflow-hidden bg-white text-neutral-900 dark:bg-[#161a20] dark:text-white transition-colors">
      ...
      >
        ...
        {/* Media + Card wrapper */}
        <div className="relative z-10 mb-0 sm:mb-2 flex flex-col items-center justify-center gap-4 -translate-y-[4vh] md:translate-y-0">
          ...
          <div className="hidden md:block w-full px-4 sm:px-6">
            <div className="relative mx-auto w-full max-w-2xl rounded-[56px] border border-black/10 dark:border-white/20 shadow-[0_16px_60px_rgba(0,0,0,0.15)] px-6 py-6 backdrop-blur-[45px] bg-white/70 dark:bg-white/[0.03]">
