    ...
    <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
      ...
      {mode === 'face' && (
        <div
          ...
          className="relative"
          style={{ width: '86%', aspectRatio: '3 / 4' }}
        >
      ...
      {mode === 'hair' && (
        <div aria-label="hair-guide" className="relative" style={{ width: '84%', aspectRatio: '3 / 4' }}>
          <svg viewBox="0 0 300 400" className="w-full h-full">
            {/* Top focus arc */}
      ...
      {mode === 'body' && (
        <div aria-label="body-guide" className="relative" style={{ width: '76%', aspectRatio: '9 / 16' }}>
