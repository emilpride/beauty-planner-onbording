...
class BirthdayCalendarHeader extends StatefulWidget {
  BirthdayCalendarHeader({super.key});
  final DatePickerController controller = DatePickerController.instance;

  @override
  State<BirthdayCalendarHeader> createState() => _BirthdayCalendarHeaderState();
}

class _BirthdayCalendarHeaderState extends State<BirthdayCalendarHeader>
              ...
              _showOverlay(
                ...
                initialValue:
                    widget
                        .controller
                        .months[widget.controller.displayDate.value.month - 1],
                offset: const Offset(130.0, 45.0),
                onSelected:
